...
final class TechCell: UICollectionViewCell {
    lazy var collectionView: UICollectionView = {
       ...
       private let cellIdentifier = "TechCell"
...
extension TechCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
